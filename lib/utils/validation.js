 ...
 * PRD 0059: Smart Slug Validation for Projects & Brands
 */
...
/**
 * Generate a URL-friendly slug from text with Vietnamese character support
...
/**
 * Validate slug format (lowercase, numbers, hyphens only, no consecutive hyphens)
...
export function validateSlug(slug) {
  ...
  if (slug.length > 100) {
    return {
      valid: false,
      error: "Slug is too long (maximum 100 characters)",
    };
  }
